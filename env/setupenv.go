...
(fitness? mating?)
*/
func SetupEnvironment(chrSizes []int64, recRate []float64, hostsilencetrigger int64, episilence float64, selfrate float64, minFitness float64, maxInsertions float64) {
